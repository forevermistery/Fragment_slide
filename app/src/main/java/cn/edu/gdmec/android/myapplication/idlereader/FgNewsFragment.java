...
public class FgNewsFragment extends Fragment  {
    ...
    private void setViewPager(){
        fragments.add(FgListNewsFragment.newInstance(NEWS_TYPE_TOP));
        fragments.add(FgListNewsFragment.newInstance(NEWS_TYPE_NBA));
        fragments.add(FgListNewsFragment.newInstance(NEWS_TYPE_JOKES));
        fragmentTitles.add("头条");
        fragmentTitles.add("NBA");
        fragmentTitles.add("笑话");
        MyFragementAdapter adapter=new MyFragementAdapter(getChildFragmentManager(),fragments ,fragmentTitles);
